...
package com.android.systemui.wrath.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.wrath.header.STATUS_BAR_HEADER_UPDATE";
