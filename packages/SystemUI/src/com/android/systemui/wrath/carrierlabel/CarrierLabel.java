...
package com.android.systemui.wrath.carrierlabel;
...
import com.android.systemui.wrath.carrierlabel.SpnOverride;
...
public class CarrierLabel extends TextView implements DarkReceiver {
    ...
    public CarrierLabel(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (WrathUtils.hasNotch(mContext)) {
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TelephonyIntents.SPN_STRINGS_UPDATED_ACTION.equals(action)
                ...
                isCN = WrathUtils.isChineseLanguage();
            }
        }
    };
